...
sig_ppgs_res_df <- ppgs_res_df %>%
  mutate(bonferroni_thresh = case_when(
    pathway_group == "hallmark" ~ bonferroni_list[["hallmark"]],
    pathway_group == "kegg_legacy" ~ bonferroni_list[["kegg_legacy"]],
    pathway_group == "kegg_medicus" ~ bonferroni_list[["kegg_medicus"]]
  )) %>%
...
ppgs_res_df %>%
  ...
  mutate(y = factor(y, levels = outcomes, labels = outcomes_clean)) %>% View()
...
# Comparison of pPGS and GWIS approaches
